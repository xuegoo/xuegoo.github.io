...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "创建列表和....";  // untranslated
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "从第一个找下级列表";  // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "找寻下级列表从 # 从末尾";  // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "找寻下级列表从 #";  // untranslated
...
Blockly.Msg.LISTS_INDEX_OF_FIRST = "找到第一个出现的对象";  // untranslated
Blockly.Msg.LISTS_INDEX_OF_HELPURL = "https://code.google.com/p/blockly/wiki/Lists#Getting_Items_from_a_List";
Blockly.Msg.LISTS_INDEX_OF_LAST = "找到最后一个出现的对象";  // untranslated
...
Blockly.Msg.LISTS_REPEAT_TITLE = "创建列表和对象 %1 重复 %2 次";  // untranslated
